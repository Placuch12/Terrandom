...
namespace Terrandom.Content.Tiles.Furniture
{
	...
	// yes i copied straight from examplemod dont judge me
	...
	public class ElderGamumuhtRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "Terrandom/Content/Tiles/Furniture/ElderGamumuhtRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "Terrandom/Content/Tiles/Furniture/RelicPedestal";

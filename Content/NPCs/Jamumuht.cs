...
namespace Terrandom.Content.NPCs
{
    public class Jamumuht : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            Banner = NPC.type;
            BannerItem = ModContent.ItemType<JamumuhtBanner>();
        }
        ...
        public override void AI()
        {
            ...
            if (target != null && !target.dead && NPC.HasValidTarget && NPC.Distance(target.Center) < 500f)
            {
                if (axeThrowTimer >= 90)
                {
                    ...
                    direction.Normalize();
                    {
                        int projectile = Projectile.NewProjectile(NPC.GetSource_FromAI(), NPC.Center, direction * 10, ModContent.ProjectileType<Projectiles.Hostile.JamumuhtTorch>(), 10, 1f, Main.myPlayer);
                    }
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
		{
			bestiaryEntry.Info.AddRange([
				...
				new FlavorTextBestiaryInfoElement("A lot of Gamumuhts have moved to the desert centuries ago and invented golf.")
			]);
		}

        public override void ModifyNPCLoot(NPCLoot npcLoot) {
			npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<Flint>(), 1, 1, 2));
            npcLoot.Add(ItemDropRule.Common(ItemID.DepthMeter, 50));
            npcLoot.Add(ItemDropRule.Common(ItemID.Torch, 1, 10, 15));
		}
    }
}
